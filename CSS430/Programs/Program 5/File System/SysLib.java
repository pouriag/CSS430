...
public class SysLib {
	...
	public static int write(int fd, byte buff[]) {
    	return Kernel.interrupt(Kernel.INTERRUPT_SOFTWARE,
				Kernel.WRITE, fd, buff);
	}

	public static int read(int fd, byte buff[]) {
    	return Kernel.interrupt(Kernel.INTERRUPT_SOFTWARE,
				Kernel.READ, fd, buff);
	}
